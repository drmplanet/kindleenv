...
cl /nologo -Iinclude scripts/namedump.c source/fitz/logs.c
...
cl /nologo -Iinclude scripts/fontdump.c  source/fitz/logs.c setargv.obj
cl /nologo -Iinclude scripts/cmapdump.c  source/fitz/logs.c setargv.obj
cl /nologo -Iinclude scripts/cquote.c  source/fitz/logs.c setargv.obj
cl /nologo -Iinclude scripts/bin2hex.c source/fitz/logs.c setargv.obj
