...
//void pdfapp_copytext(pdfapp_if_t *papp, MyRectangle myrect, int *ucsbuf, int* ucslen);
void pdfapp_copytext(pdfapp_t *app, MyRectangle myrect, int *ucsbuf, int *insize, MyRectangle* outrect);
void pdfapp_getlinepos(pdfapp_t *app, int start_x, int start_y, MyRectangle* outrect);
